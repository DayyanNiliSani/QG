...
import { CreateCategoryRequest } from 'src/API/Dto/Requests/createCategory.request';
import { UpdateCategoryRequest } from 'src/API/Dto/Requests/updateCategory.request';
import { GetAllCategoryResponse } from 'src/API/Dto/Responses/getAllCategory.response';
